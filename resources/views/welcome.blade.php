        ...
        <div class="row align-items-center min-vh-75">
            <div class="col-lg-6 text-center text-lg-start">
                <div class="hero-content">
                    <img src="{{ asset('images/logo.png') }}" alt="شعار الرضوان" class="hero-logo mb-4">
                    ...
                    <div class="hero-buttons">
                        <a href="{{ route('invoices.create') }}" class="btn btn-primary btn-lg me-3 mb-2">
                            <i class="fas fa-plus-circle"></i> إنشاء فاتورة جديدة
                        </a>
                        <a href="{{ route('customers.index') }}" class="btn btn-outline-primary btn-lg mb-2">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="feature-card card h-100 border-0 shadow-sm">
                    <div class="card-body text-center p-4">
                        ...
                        <a href="{{ route('payments.create') }}" class="btn btn-outline-warning">
