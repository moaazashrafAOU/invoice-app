    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="<?php echo e(url('/')); ?>">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="شعار الرضوان" style="height: 40px; margin-left: 10px; filter: brightness(0) invert(1);">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link btn btn-outline-light" href="<?php echo e(route('invoices.create')); ?>">
                            <i class="fas fa-plus"></i> فاتورة جديدة
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link btn btn-warning text-dark" href="<?php echo e(route('payments.create')); ?>">
...
<?php /**PATH D:\ABDALLA\invoice-app-final-updated\invoice-app\resources\views/layouts/app.blade.php ENDPATH**/ ?>