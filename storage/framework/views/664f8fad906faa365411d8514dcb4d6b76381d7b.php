                        ...
                        <select class="form-select" name="customer_id" id="customer_id" required>
                            ...
                            <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($customer->id); ?>" 
                                        ...
                                        data-initial-balance="<?php echo e($customer->initial_balance); ?>"
                                        <?php echo e($selectedCustomer && $selectedCustomer->id == $customer->id ? 'selected' : ''); ?>>
                                    <?php echo e($customer->name); ?> - الرصيد: <?php echo e(number_format($customer->balance, 2)); ?> جنيه
                                </option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ABDALLA\invoice-app-final-updated\invoice-app\resources\views/payments/create.blade.php ENDPATH**/ ?>